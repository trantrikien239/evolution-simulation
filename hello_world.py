...
class World():
    def __init__(self, length = 200, life_forms = None):
...
def main():
    ...
    logging.info('\n=============>>> Simulation ends!\n')
    logging.info('Number of blobs have ever lived: {}'.format(len(Blobs)))
